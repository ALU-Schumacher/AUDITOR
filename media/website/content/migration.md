...
- The format of the config file was changed from INI to YAML. An updated example config file can be found in the [Documentation](https://alu-schumacher.github.io/AUDITOR/latest/#apel-plugin).
