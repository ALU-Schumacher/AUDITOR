...
- Dependencies: Update bump anyhow from 1.0.102 to 1.0.103 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
- Dependencies: Update ruff from 0.15.12 to 0.15.18 in /plugins/utilization_tool ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
