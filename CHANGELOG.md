...
- Dependencies: Update k8s-openapi from 0.21.1 to 0.26.1 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update kube from 0.88.1 to 2.0.1 ([@dirksammel](https://github.com/dirksammel))
