...
- Dependencies: Update ruff from 0.3.2 to 0.4.9 ([@dirksammel](https://github.com/dirksammel))
...
- Dependencies: Update setuptools from 69.2.0 to 70.1.1 ([@dirksammel](https://github.com/dirksammel))
