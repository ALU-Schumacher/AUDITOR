...
- Dependencies: Update crate-ci/typos from 1.20.7 to 1.23.2 ([@dirksammel](https://github.com/dirksammel))
...
- Dependencies: Update setuptools from 69.2.0 to 70.3.0 ([@dirksammel](https://github.com/dirksammel))
