...
- Dependencies: Update crate-ci/typos from 1.38.1 to 1.43.2 ([@dirksammel](https://github.com/dirksammel))
...
- Dependencies: Update ruff from 0.14.2 to 0.15.0 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update serde_json from 1.0.145 to 1.0.147 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update setuptools from 80.9.0 to 80.10.2 ([@dirksammel](https://github.com/dirksammel))
