...
- Dependencies: Update crate-ci/typos from 1.20.7 to 1.23.1 ([@dirksammel](https://github.com/dirksammel))
...
- Dependencies: Update ruff from 0.3.2 to 0.5.1 ([@dirksammel](https://github.com/dirksammel))
- Dependencies: Update serde from 1.0.198 to 1.0.203 ([@QuantumDancer](https://github.com/QuantumDancer), [@dirksammel](https://github.com/dirksammel))
...
- Dependencies: Update setuptools from 69.2.0 to 70.2.0 ([@dirksammel](https://github.com/dirksammel))
...
- Dependencies: Update types-requests from 2.31.0.20240406 to 2.32.0.20240622 ([@dirksammel](https://github.com/dirksammel))
...
- Dependencies: Update uuid from 1.8.0 to 1.9.1 ([@raghuvar-vijay](https://github.com/raghuvar-vijay))
...
[Unreleased]: https://github.com/alu-schumacher/AUDITOR/compare/v0.6.0...HEAD
...
[0.6.0]: https://github.com/alu-schumacher/AUDITOR/releases/tag/v0.6.0
