...
class Config:
    ...
    _default_config: ClassVar[T_Config] = {
        ...
        "log_file": None,
        "history_file": None,
        "earliest_datetime": datetime.now(tz=timezone.utc).date().isoformat(),
        "query_type": "shell",
        "class_ads": frozenset(
            (
                "GlobalJobId",
    ...
    def __init__(self, args: Namespace):
        ...
        self._config["condor_timestamp"] = int(
            datetime.fromisoformat(self.earliest_datetime).timestamp()
        )
    ...
    def _verify(self):
        ...
        ) -> T_Config | int | str | list[T_Config] | list[int] | list[str] | None:
